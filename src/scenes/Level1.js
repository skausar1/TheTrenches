class Level1 extends Phaser.Scene {
    ...
    create(){ 
        ...
        //Displays O2 meter
        this.O2Display = this.add.text(500, 97, Math.round(this.Player.oxy), this.O2Config).setScrollFactor(0).setScale(0.75).setDepth(102);
    ...
    onEvent(){
            ...
            var music = this.sound.add(clip, {
                rate: Phaser.Math.Between(0.5, 2),
                volume: Phaser.Math.Between(0.125, 0.25)
            });
            music.play();
